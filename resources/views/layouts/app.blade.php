                ...
                @auth
                    <li class="nav-item dropdown ms-3">
                        <a class="nav-link dropdown-toggle d-flex align-items-center py-1" href="#" id="userDropdown"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false" style="min-height: 50px;">
            ...
            <div class="row g-4 p-3">
                ...
                <div class="col-md-4 text-center text-md-start">
                    <a href="#" class="d-inline-block mb-3">
                        <img src="{{ asset('images/logo3.png') }}" alt="Logo" width="60"
                            class="footer-brand">
                    </a>
                    <p class="text-muted mb-2"><i>"Your trusted partner in finding internships that launch careers"</i>
                    </p>
                ...
                <div class="col-md-4 text-center text-md-end">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="aribouchaimae021@gmail.com"
                                class="footer-link">info@company.com</a></li>
