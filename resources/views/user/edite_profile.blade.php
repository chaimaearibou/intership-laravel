...
<div class="user-profile-container">
    ...
    <div class="user-profile-content">
        ...
        <section class="user-profile-section">
            ...
            <form action="{{ route('profile.update', ['candidat_profile' => $profile->candidat_id]) }}" 
                  method="POST" enctype="multipart/form-data" class="user-profile-info-grid">
                @csrf
                @method('PUT')
                ...
                <div class="user-profile-info-item">
                    ...
                    <input type="text" id="prenom_candidat" name="prenom_candidat" 
                           class="user-profile-info-value"
                ...
                <div class="user-profile-info-item">
                    ...
                    <input type="text" id="number" name="number" 
                           ...
                           value="{{ old('number', $profile->number) }}" maxlength="20">
                </div>
